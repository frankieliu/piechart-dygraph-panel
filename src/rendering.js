...
export default function link(scope, elem, attrs, ctrl) {
  ...
  function addPieChart() {
    ...
    var plotCanvas = $('<div id="hh" style="width:600px"></div>');
    var plotCss = {
      margin: 'auto',
      position: 'relative',
      paddingBottom: 20 + 'px',
    ...
    var data0 = [];
    var data0_len = 1000000;
    for (var i = 0; i < data0_len; i++) {
      var base = 10 * Math.sin(i/(90.0 * data0_len/1000));
      data0.push([i, base, base + Math.sin(i/2.0)]);
    }
    // shift one portion out of line
    var h_start = data0_len * 0.45;
    var h_end = data0_len * 0.5;
